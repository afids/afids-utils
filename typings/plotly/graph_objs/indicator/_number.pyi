...
class Number(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def font(self): # -> tuple[Unknown, ...] | Number | None:
        """
    ...
    @property
    def prefix(self): # -> tuple[Unknown, ...] | Number | None:
        """
    ...
    @property
    def suffix(self): # -> tuple[Unknown, ...] | Number | None:
        """
    ...
    @property
    def valueformat(self): # -> tuple[Unknown, ...] | Number | None:
        """
