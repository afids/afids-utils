...
class rrulewrapper:
    ...
    def __getattr__(self, name): # -> Any | _Wrapped[..., Unknown, (*args: Unknown, **kwargs: Unknown), list[Unknown]]:
        ...
...
class RRuleLocator(DateLocator):
    ...
    def __call__(self): # -> list[Unknown] | NDArray[Any] | NDArray[floating[Any]] | Any:
        ...
    
    def tick_values(self, vmin, vmax): # -> NDArray[Any] | NDArray[floating[Any]] | Any:
        ...
...
def date_ticker_factory(span, tz=..., numticks=...): # -> tuple[YearLocator | MonthLocator | WeekdayLocator | DayLocator | HourLocator | MinuteLocator, DateFormatter]:
    """
...
class _SwitchableDateConverter:
    ...
    def convert(self, *args, **kwargs): # -> NDArray[Any] | NDArray[floating[Any]] | Any:
        ...
