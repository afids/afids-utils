...
class ScalarFormatter(Formatter):
    ...
    **Offset notation and scientific notation**
    ...
    """
    def __init__(self, useOffset=..., useMathText=..., useLocale=...) -> None:
        ...
    ...
    def format_data_short(self, value): # -> Literal['']:
        ...
...
class LogFormatter(Formatter):
    ...
    """
    def __init__(self, base=..., labelOnlyBase=..., minor_thresholds=..., linthresh=...) -> None:
        ...
    ...
    def __call__(self, x, pos=...): # -> Literal['0', '']:
        ...
...
class LogFormatterMathtext(LogFormatter):
    ...
    Format values for log axis using ``exponent = log_base(value)``.
    """
    def __call__(self, x, pos=...): # -> LiteralString | str:
        ...
...
class LogitFormatter(Formatter):
    ...
    """
    def __init__(self, *, use_overline=..., one_half=..., minor=..., minor_threshold=..., minor_number=...) -> None:
        r"""
        Parameters
        ----------
...
class EngFormatter(Formatter):
    ...
    """
    ENG_PREFIXES = ...
    def __init__(self, unit=..., places=..., sep=..., *, usetex=..., useMathText=...) -> None:
        r"""
        Parameters
        ----------
        unit : str, default: ""
...
class PercentFormatter(Formatter):
    ...
    """
    def __init__(self, xmax=..., decimals=..., symbol=..., is_latex=...) -> None:
        ...
...
class LinearLocator(Locator):
    ...
    """
    def __init__(self, numticks=..., presets=...) -> None:
        """
        Parameters
        ----------
...
def scale_range(vmin, vmax, n=..., threshold=...): # -> tuple[float, float | Literal[0]]:
    ...
...
class MaxNLocator(Locator):
    ...
    """
    default_params = ...
    def __init__(self, nbins=..., **kwargs) -> None:
        """
        Parameters
        ----------
...
@_api.deprecated("3.6")
def is_decade(x, base=..., *, rtol=...): # -> Any | bool:
    ...
...
class LogLocator(Locator):
    ...
    def __call__(self): # -> NDArray[Any] | float | int | NDArray[Unknown] | NDArray[floating[Any]]:
        """Return the locations of the ticks."""
        ...
    
    def tick_values(self, vmin, vmax): # -> NDArray[Any] | float | int | NDArray[Unknown] | NDArray[floating[Any]]:
        ...
    
    def view_limits(self, vmin, vmax): # -> tuple[float | Unknown | int | Any, float | Unknown | int | Any]:
        """Try to choose the view limits intelligently."""
        ...
    
    def nonsingular(self, vmin, vmax): # -> tuple[Unknown | int | float, Unknown | int | float]:
        ...
...
class SymmetricalLogLocator(Locator):
    ...
    def tick_values(self, vmin, vmax): # -> list[Unknown] | ndarray[Any, dtype[Unknown]]:
        ...
...
class AsinhLocator(Locator):
    ...
    """
    def __init__(self, linear_width, numticks=..., symthresh=..., base=..., subs=...) -> None:
        """
        Parameters
        ----------
        linear_width : float
...
class LogitLocator(MaxNLocator):
    ...
    """
    def __init__(self, minor=..., *, nbins=...) -> None:
        """
    ...
    def tick_values(self, vmin, vmax): # -> NDArray[Any] | ndarray[Any, dtype[Unknown]] | list[Unknown] | float | int:
        ...
    
    def nonsingular(self, vmin, vmax): # -> tuple[float | Unknown | int, float | Unknown | int]:
        ...
