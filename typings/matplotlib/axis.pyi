...
class Tick(martist.Artist):
    ...
    """
    def __init__(self, axes, loc, *, size=..., width=..., color=..., tickdir=..., pad=..., labelsize=..., labelcolor=..., zorder=..., gridOn=..., tick1On=..., tick2On=..., label1On=..., label2On=..., major=..., labelrotation=..., grid_color=..., grid_linestyle=..., grid_linewidth=..., grid_alpha=..., **kwargs) -> None:
        """
...
class Axis(martist.Artist):
    ...
    def get_transform(self): # -> IdentityTransform | LogTransform | SymmetricalLogTransform | AsinhTransform | LogitTransform | FuncTransform | Transform | CompositeAffine2D | CompositeGenericTransform | _NotImplementedType:
        ...
    ...
    def limit_range_for_scale(self, vmin, vmax): # -> tuple[Unknown, Unknown] | tuple[float | Unknown, float | Unknown]:
        ...
    ...
    def set_ticklabels(self, labels, *, minor=..., fontdict=..., **kwargs): # -> list[Unknown]:
        r"""
