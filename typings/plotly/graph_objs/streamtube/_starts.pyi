...
class Starts(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def x(self): # -> tuple[Unknown, ...] | Starts | None:
        """
    ...
    @property
    def xsrc(self): # -> tuple[Unknown, ...] | Starts | None:
        """
    ...
    @property
    def y(self): # -> tuple[Unknown, ...] | Starts | None:
        """
    ...
    @property
    def ysrc(self): # -> tuple[Unknown, ...] | Starts | None:
        """
    ...
    @property
    def z(self): # -> tuple[Unknown, ...] | Starts | None:
        """
    ...
    @property
    def zsrc(self): # -> tuple[Unknown, ...] | Starts | None:
        """
