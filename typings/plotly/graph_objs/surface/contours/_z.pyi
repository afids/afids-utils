...
class Z(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def color(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def end(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def highlight(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def highlightcolor(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def highlightwidth(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def project(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def show(self): # -> tuple[Unknown, ...] | Z | None:
        """
        Determines whether or not contour lines about the z dimension
        are drawn.
    ...
    @property
    def size(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def start(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def usecolormap(self): # -> tuple[Unknown, ...] | Z | None:
        """
    ...
    @property
    def width(self): # -> tuple[Unknown, ...] | Z | None:
        """
