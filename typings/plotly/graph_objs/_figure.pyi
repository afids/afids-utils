...
class Figure(BaseFigure):
    ...
    def add_candlestick(self, close=..., closesrc=..., customdata=..., customdatasrc=..., decreasing=..., high=..., highsrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., line=..., low=..., lowsrc=..., meta=..., metasrc=..., name=..., opacity=..., open=..., opensrc=..., selectedpoints=..., showlegend=..., stream=..., text=..., textsrc=..., uid=..., uirevision=..., visible=..., whiskerwidth=..., x=..., xaxis=..., xcalendar=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., yaxis=..., yhoverformat=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def add_carpet(self, a=..., a0=..., aaxis=..., asrc=..., b=..., b0=..., baxis=..., bsrc=..., carpet=..., cheaterslope=..., color=..., customdata=..., customdatasrc=..., da=..., db=..., font=..., ids=..., idssrc=..., legend=..., legendgrouptitle=..., legendrank=..., legendwidth=..., meta=..., metasrc=..., name=..., opacity=..., stream=..., uid=..., uirevision=..., visible=..., x=..., xaxis=..., xsrc=..., y=..., yaxis=..., ysrc=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def add_funnel(self, alignmentgroup=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., marker=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., uid=..., uirevision=..., visible=..., width=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def add_ohlc(self, close=..., closesrc=..., customdata=..., customdatasrc=..., decreasing=..., high=..., highsrc=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., line=..., low=..., lowsrc=..., meta=..., metasrc=..., name=..., opacity=..., open=..., opensrc=..., selectedpoints=..., showlegend=..., stream=..., text=..., textsrc=..., tickwidth=..., uid=..., uirevision=..., visible=..., x=..., xaxis=..., xcalendar=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., yaxis=..., yhoverformat=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def add_waterfall(self, alignmentgroup=..., base=..., cliponaxis=..., connector=..., constraintext=..., customdata=..., customdatasrc=..., decreasing=..., dx=..., dy=..., hoverinfo=..., hoverinfosrc=..., hoverlabel=..., hovertemplate=..., hovertemplatesrc=..., hovertext=..., hovertextsrc=..., ids=..., idssrc=..., increasing=..., insidetextanchor=..., insidetextfont=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., measure=..., measuresrc=..., meta=..., metasrc=..., name=..., offset=..., offsetgroup=..., offsetsrc=..., opacity=..., orientation=..., outsidetextfont=..., selectedpoints=..., showlegend=..., stream=..., text=..., textangle=..., textfont=..., textinfo=..., textposition=..., textpositionsrc=..., textsrc=..., texttemplate=..., texttemplatesrc=..., totals=..., uid=..., uirevision=..., visible=..., width=..., widthsrc=..., x=..., x0=..., xaxis=..., xhoverformat=..., xperiod=..., xperiod0=..., xperiodalignment=..., xsrc=..., y=..., y0=..., yaxis=..., yhoverformat=..., yperiod=..., yperiod0=..., yperiodalignment=..., ysrc=..., row=..., col=..., secondary_y=..., **kwargs) -> Figure:
        """
    ...
    def for_each_annotation(self, fn, selector=..., row=..., col=..., secondary_y=...): # -> Self@Figure:
        """
    ...
    def for_each_layout_image(self, fn, selector=..., row=..., col=..., secondary_y=...): # -> Self@Figure:
        """
    ...
    def for_each_selection(self, fn, selector=..., row=..., col=..., secondary_y=...): # -> Self@Figure:
        """
    ...
    def for_each_shape(self, fn, selector=..., row=..., col=..., secondary_y=...): # -> Self@Figure:
        """
    ...
    def add_shape(self, arg=..., editable=..., fillcolor=..., fillrule=..., label=..., layer=..., legend=..., legendgroup=..., legendgrouptitle=..., legendrank=..., legendwidth=..., line=..., name=..., opacity=..., path=..., showlegend=..., templateitemname=..., type=..., visible=..., x0=..., x1=..., xanchor=..., xref=..., xsizemode=..., y0=..., y1=..., yanchor=..., yref=..., ysizemode=..., row=..., col=..., secondary_y=..., exclude_empty_subplots=..., **kwargs) -> Figure:
        """
