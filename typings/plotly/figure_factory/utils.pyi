...
def flatten(array): # -> list[Unknown]:
    """
...
def endpts_to_intervals(endpts): # -> list[Unknown]:
    """
...
def annotation_dict_for_label(text, lane, num_of_lanes, subplot_spacing, row_col=..., flipped=..., right_side=..., text_color=...): # -> dict[str, Unbound | int]:
    """
