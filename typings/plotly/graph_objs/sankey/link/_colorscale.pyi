...
class Colorscale(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def cmax(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
    ...
    @property
    def cmin(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
    ...
    @property
    def colorscale(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
    ...
    @property
    def label(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
    ...
    @property
    def name(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
    ...
    @property
    def templateitemname(self): # -> tuple[Unknown, ...] | Colorscale | None:
        """
