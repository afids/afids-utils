...
class HandlerNpoints(HandlerBase):
    ...
    def get_xdata(self, legend, xdescent, ydescent, width, height, fontsize): # -> tuple[Unknown | list[Unknown], Unknown | list[Unknown]]:
        ...
...
class HandlerRegularPolyCollection(HandlerNpointsYoffsets):
    ...
    def create_collection(self, orig_handle, sizes, offsets, offset_transform): # -> Any:
        ...
...
class HandlerErrorbar(HandlerLine2D):
    ...
    def create_artists(self, legend, orig_handle, xdescent, ydescent, width, height, fontsize, trans): # -> list[Unknown | Line2D]:
        ...
