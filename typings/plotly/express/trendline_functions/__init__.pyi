...
def ols(trendline_options, x_raw, x, y, x_label, y_label, non_missing): # -> tuple[Any | Unknown, Unknown, Unknown]:
...
def lowess(trendline_options, x_raw, x, y, x_label, y_label, non_missing): # -> tuple[Unknown, Literal['<b>LOWESS trendline</b><br><br>'], None]:
