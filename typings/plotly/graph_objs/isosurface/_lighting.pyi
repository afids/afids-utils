...
class Lighting(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def ambient(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def diffuse(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def facenormalsepsilon(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def fresnel(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def roughness(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def specular(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    @property
    def vertexnormalsepsilon(self): # -> tuple[Unknown, ...] | Lighting | None:
        """
    ...
    def __init__(self, arg=..., ambient=..., diffuse=..., facenormalsepsilon=..., fresnel=..., roughness=..., specular=..., vertexnormalsepsilon=..., **kwargs) -> None:
        """
