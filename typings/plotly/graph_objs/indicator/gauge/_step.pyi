...
class Step(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def color(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def line(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def range(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def thickness(self): # -> tuple[Unknown, ...] | Step | None:
        """
