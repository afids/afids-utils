...
class Exporter:
    ...
    @staticmethod
    def process_transform(transform, ax=..., data=..., return_trans=..., force_trans=...): # -> tuple[Literal['data', 'axes', 'figure', 'display'], Unknown, Unknown | BlendedGenericTransform] | tuple[Literal['data', 'axes', 'figure', 'display'], Unknown] | tuple[Literal['data', 'axes', 'figure', 'display'], Unknown | BlendedGenericTransform] | Literal['data', 'axes', 'figure', 'display']:
