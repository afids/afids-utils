...
class Camera(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def center(self): # -> tuple[Unknown, ...] | Camera | None:
        """
    ...
    @property
    def eye(self): # -> tuple[Unknown, ...] | Camera | None:
        """
    ...
    @property
    def projection(self): # -> tuple[Unknown, ...] | Camera | None:
        """
    ...
    @property
    def up(self): # -> tuple[Unknown, ...] | Camera | None:
        """
