...
class Surface(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def count(self): # -> tuple[Unknown, ...] | Surface | None:
        """
    ...
    @property
    def fill(self): # -> tuple[Unknown, ...] | Surface | None:
        """
    ...
    @property
    def pattern(self): # -> tuple[Unknown, ...] | Surface | None:
        """
    ...
    @property
    def show(self): # -> tuple[Unknown, ...] | Surface | None:
        """
