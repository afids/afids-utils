...
def composite_images(images, renderer, magnification=...): # -> tuple[NDArray[uint8], Literal[0], Literal[0]] | tuple[NDArray[uint8], Unknown, Unknown]:
    """
...
class _ImageBase(martist.Artist, cm.ScalarMappable):
    ...
    """
    zorder = ...
    def __init__(self, ax, cmap=..., norm=..., interpolation=..., origin=..., filternorm=..., filterrad=..., resample=..., *, interpolation_stage=..., **kwargs) -> None:
        ...
    ...
    def contains(self, mouseevent): # -> tuple[Literal[False], dict[Unknown, Unknown]] | tuple[Unknown | Literal[False], dict[Unknown, Unknown]]:
...
class AxesImage(_ImageBase):
    ...
    **kwargs : `~matplotlib.artist.Artist` properties
    ...
    def __init__(self, ax, cmap=..., norm=..., interpolation=..., origin=..., extent=..., filternorm=..., filterrad=..., resample=..., *, interpolation_stage=..., **kwargs) -> None:
        ...
    ...
    def get_extent(self): # -> list[Unknown] | tuple[float, Unknown, Unknown, float] | tuple[float, Unknown, float, Unknown]:
...
class NonUniformImage(AxesImage):
    ...
    def make_image(self, renderer, magnification=..., unsampled=...): # -> tuple[ndarray[Any, dtype[uint8]], Unknown, Unknown, IdentityTransform]:
        ...
...
class FigureImage(_ImageBase):
    ...
    _interpolation = ...
    @_api.make_keyword_only("3.6", name="cmap")
    def __init__(self, fig, cmap=..., norm=..., offsetx=..., offsety=..., origin=..., **kwargs) -> None:
        """
        cmap is a colors.Colormap instance
        norm is a colors.Normalize instance to map luminance to 0-1
...
class BboxImage(_ImageBase):
    ...
    @_api.make_keyword_only("3.6", name="cmap")
    def __init__(self, bbox, cmap=..., norm=..., interpolation=..., origin=..., filternorm=..., filterrad=..., resample=..., **kwargs) -> None:
        """
        cmap is a colors.Colormap instance
        norm is a colors.Normalize instance to map luminance to 0-1
...
def imread(fname, format=...): # -> NDArray[float32] | Any | NDArray[Unknown] | NDArray[Any]:
    """
...
def imsave(fname, arr, vmin=..., vmax=..., cmap=..., format=..., origin=..., dpi=..., *, metadata=..., pil_kwargs=...): # -> None:
    """
...
def thumbnail(infile, thumbfile, scale=..., interpolation=..., preview=...): # -> FigureBase | Figure:
    """
