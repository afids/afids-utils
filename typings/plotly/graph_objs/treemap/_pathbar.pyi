...
class Pathbar(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def edgeshape(self): # -> tuple[Unknown, ...] | Pathbar | None:
        """
    ...
    @property
    def side(self): # -> tuple[Unknown, ...] | Pathbar | None:
        """
    ...
    @property
    def textfont(self): # -> tuple[Unknown, ...] | Pathbar | None:
        """
    ...
    @property
    def thickness(self): # -> tuple[Unknown, ...] | Pathbar | None:
        """
    ...
    @property
    def visible(self): # -> tuple[Unknown, ...] | Pathbar | None:
        """
