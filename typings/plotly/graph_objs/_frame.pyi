...
class Frame(_BaseFrameHierarchyType):
    ...
    _valid_props = ...
    @property
    def baseframe(self): # -> tuple[Unknown, ...] | Frame | None:
        """
    ...
    @property
    def data(self): # -> tuple[Unknown, ...] | Frame | None:
        """
    ...
    @property
    def group(self): # -> tuple[Unknown, ...] | Frame | None:
        """
    ...
    @property
    def layout(self): # -> tuple[Unknown, ...] | Frame | None:
        """
    ...
    @property
    def name(self): # -> tuple[Unknown, ...] | Frame | None:
        """
    ...
    @property
    def traces(self): # -> tuple[Unknown, ...] | Frame | None:
        """
