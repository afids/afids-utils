...
class Smith(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def bgcolor(self): # -> tuple[Unknown, ...] | Smith | None:
        """
    ...
    @property
    def domain(self): # -> tuple[Unknown, ...] | Smith | None:
        """
    ...
    @property
    def imaginaryaxis(self): # -> tuple[Unknown, ...] | Smith | None:
        """
    ...
    @property
    def realaxis(self): # -> tuple[Unknown, ...] | Smith | None:
        """
