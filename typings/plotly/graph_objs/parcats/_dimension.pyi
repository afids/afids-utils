...
class Dimension(_BaseTraceHierarchyType):
    ...
    _valid_props = ...
    @property
    def categoryarray(self): # -> tuple[Unknown, ...] | Dimension | None:
        """
    ...
    @property
    def categoryarraysrc(self): # -> tuple[Unknown, ...] | Dimension | None:
        """
    ...
    @property
    def categoryorder(self): # -> tuple[Unknown, ...] | Dimension | None:
        """
    ...
    @property
    def displayindex(self): # -> tuple[Unknown, ...] | Dimension | None:
        """
