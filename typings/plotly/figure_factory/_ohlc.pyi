...
def make_increasing_ohlc(open, high, low, close, dates, **kwargs): # -> dict[str, str | list[Unknown] | bool]:
    """
...
def make_decreasing_ohlc(open, high, low, close, dates, **kwargs): # -> dict[str, str | list[Unknown]]:
    """
...
class _OHLC:
    ...
    def get_increase(self): # -> tuple[list[Unknown], list[Unknown], tuple[Literal['Open', 'High', 'Low', 'Close', ''], ...]]:
        """
    ...
    def get_decrease(self): # -> tuple[list[Unknown], list[Unknown], tuple[Literal['Open', 'High', 'Low', 'Close', ''], ...]]:
        """
