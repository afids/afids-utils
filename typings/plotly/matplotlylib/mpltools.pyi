...
def convert_symbol(mpl_symbol): # -> list[Unknown] | str:
...
def convert_x_domain(mpl_plot_bounds, mpl_max_x_bounds): # -> list[Unknown]:
...
def convert_y_domain(mpl_plot_bounds, mpl_max_y_bounds): # -> list[Unknown]:
...
def display_to_paper(x, y, layout): # -> tuple[Unknown, Unknown]:
...
def get_axes_bounds(fig): # -> tuple[tuple[Unknown, Unknown], tuple[Unknown, Unknown]]:
...
def convert_rgba_array(color_list): # -> list[Unknown]:
    ...

def convert_path_array(path_array): # -> list[Unknown]:
    ...
...
def make_bar(**props): # -> dict[str, Unknown]:
...
def prep_ticks(ax, index, ax_type, props): # -> dict[Unknown, Unknown] | dict[str, Unknown] | dict[str, str | None]:
...
def prep_xy_axis(ax, props, x_bounds, y_bounds): # -> tuple[dict[str, list[Unknown] | dict[str, Unknown]], dict[str, list[Unknown] | dict[str, Unknown]]]:
    ...
