...
class Button(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def args(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def args2(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def execute(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def label(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def method(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def name(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def templateitemname(self): # -> tuple[Unknown, ...] | Button | None:
        """
    ...
    @property
    def visible(self): # -> tuple[Unknown, ...] | Button | None:
        """
