...
class BaseFigure:
    ...
    def __reduce__(self): # -> tuple[type[BaseFigure], tuple[dict[str, list[Unknown] | Any | Unknown]]]:
        """
    ...
    def __getitem__(self, prop): # -> list[Unknown] | list[Any] | tuple[Unknown, ...] | Any | Self@BaseFigure:
        ...
    ...
    def update(self, dict1=..., overwrite=..., **kwargs): # -> Self@BaseFigure:
        """
    ...
    def pop(self, key, *args): # -> list[Unknown] | list[Any] | tuple[Unknown, ...] | Any | BaseFigure:
        """
    ...
    @property
    def data(self): # -> list[Unknown] | list[Any] | tuple[Unknown, ...] | Any | BaseFigure:
        """
    ...
    def select_traces(self, selector=..., row=..., col=..., secondary_y=...): # -> Generator[Unknown, Any, None]:
        """
    ...
    def for_each_trace(self, fn, selector=..., row=..., col=..., secondary_y=...): # -> Self@BaseFigure:
        """
    ...
    def update_traces(self, patch=..., selector=..., row=..., col=..., secondary_y=..., overwrite=..., **kwargs): # -> Self@BaseFigure:
        """
    ...
    def update_layout(self, dict1=..., overwrite=..., **kwargs): # -> Self@BaseFigure:
        """
    ...
    def add_trace(self, trace, row=..., col=..., secondary_y=..., exclude_empty_subplots=...): # -> Self@BaseFigure:
        """
    ...
    def add_traces(self, data, rows=..., cols=..., secondary_ys=..., exclude_empty_subplots=...): # -> Self@BaseFigure:
        """
    ...
    def to_dict(self): # -> dict[str, list[Unknown] | Any | Unknown]:
        """
    ...
    def to_plotly_json(self): # -> dict[str, list[Unknown] | Any | Unknown]:
        """
    ...
    def to_ordered_dict(self, skip_uid=...): # -> OrderedDict[Unknown, Unknown]:
        ...
    ...
    def add_vline(self, x, row=..., col=..., exclude_empty_subplots=..., annotation=..., **kwargs): # -> Self@BaseFigure:
        ...
    
    def add_hline(self, y, row=..., col=..., exclude_empty_subplots=..., annotation=..., **kwargs): # -> Self@BaseFigure:
        ...
    
    def add_vrect(self, x0, x1, row=..., col=..., exclude_empty_subplots=..., annotation=..., **kwargs): # -> Self@BaseFigure:
        ...
    
    def add_hrect(self, y0, y1, row=..., col=..., exclude_empty_subplots=..., annotation=..., **kwargs): # -> Self@BaseFigure:
        ...
...
class BasePlotlyType:
    ...
    def __reduce__(self): # -> tuple[type[BasePlotlyType], tuple[dict[Unknown, Unknown]]]:
        """
        Custom implementation of reduce is used to support deep copying
        and pickling
        """
    ...
    def __getitem__(self, prop): # -> tuple[Unknown, ...] | Self@BasePlotlyType | None:
        """
    ...
    def update(self, dict1=..., overwrite=..., **kwargs): # -> Self@BasePlotlyType:
        """
    ...
    def pop(self, key, *args): # -> tuple[Unknown, ...] | BasePlotlyType | None:
        """
        Remove the value associated with the specified key and return it
...
class BaseLayoutType(BaseLayoutHierarchyType):
    ...
    def __getitem__(self, prop): # -> tuple[Unknown, ...] | Self@BaseLayoutType | None:
        """
