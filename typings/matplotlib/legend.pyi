...
class Legend(Artist):
    ...
    def __init__(self, parent, handles, labels, loc=..., numpoints=..., markerscale=..., markerfirst=..., reverse=..., scatterpoints=..., scatteryoffsets=..., prop=..., fontsize=..., labelcolor=..., borderpad=..., labelspacing=..., handlelength=..., handleheight=..., handletextpad=..., borderaxespad=..., columnspacing=..., ncols=..., mode=..., fancybox=..., shadow=..., title=..., title_fontsize=..., framealpha=..., edgecolor=..., facecolor=..., bbox_to_anchor=..., bbox_transform=..., frameon=..., handler_map=..., title_fontproperties=..., alignment=..., *, ncol=..., draggable=...) -> None:
        """
        Parameters
        ----------
    ...
    def get_legend_handler_map(self): # -> dict[type[StemContainer] | type[ErrorbarContainer] | type[Line2D] | type[Patch] | type[StepPatch] | type[LineCollection] | type[RegularPolyCollection] | type[CircleCollection] | type[BarContainer] | type[tuple[Unknown, ...]] | type[PathCollection] | type[PolyCollection], HandlerStem | HandlerErrorbar | HandlerLine2D | HandlerPatch | HandlerStepPatch | HandlerLineCollection | HandlerRegularPolyCollection | HandlerCircleCollection | HandlerTuple | HandlerPathCollection | HandlerPolyCollection]:
