...
class Step(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def args(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def execute(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def label(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def method(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def name(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def templateitemname(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def value(self): # -> tuple[Unknown, ...] | Step | None:
        """
    ...
    @property
    def visible(self): # -> tuple[Unknown, ...] | Step | None:
        """
