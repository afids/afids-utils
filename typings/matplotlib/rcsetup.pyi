...
def validate_dpi(s): # -> float | Literal['figure']:
...
def validate_markevery(s): # -> slice | float | int | tuple[Unknown, Unknown] | list[Unknown] | None:
    """
...
_prop_validators = ...
_prop_aliases = ...
def cycler(*args, **kwargs): # -> Cycler[Unknown, Unknown] | Any:
    """
...
def validate_cycler(s): # -> Cycler[Unknown, Unknown]:
