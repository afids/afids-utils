...
PATH_DICT = ...
def SVG_path(path, transform=..., simplify=...): # -> tuple[NDArray[float64], list[Unknown]] | tuple[ndarray[Any, dtype[Any]], list[Unknown | str | list[Unknown]]]:
...
def get_path_style(path, fill=...): # -> dict[Unknown, Unknown]:
    """Get the style dictionary for matplotlib path objects"""
    ...

def get_line_style(line): # -> dict[Unknown, Unknown]:
    """Get the style dictionary for matplotlib line objects"""
    ...

def get_marker_style(line): # -> dict[Unknown, Unknown]:
    """Get the style dictionary for matplotlib marker objects"""
    ...

def get_text_style(text): # -> dict[Unknown, Unknown]:
    """Return the text style dict for a text instance"""
    ...

def get_axis_properties(axis): # -> dict[Unknown, Unknown]:
...
def get_figure_properties(fig): # -> dict[str, Unknown]:
    ...

def get_axes_properties(ax): # -> dict[str, str | Unknown | list[dict[Unknown, Unknown]]]:
    ...

def iter_all_children(obj, skipContainers=...): # -> Generator[Unknown, Any, None]:
    """
...
def get_legend_properties(ax, legend): # -> dict[str, Unknown]:
    ...
