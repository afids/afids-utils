...
def axis_spanning_shape_annotation(annotation, shape_type, shape_args, kwargs): # -> dict[Unknown, Unknown] | None:
    """
...
def split_dict_by_key_prefix(d, prefix): # -> tuple[dict[Unknown, Unknown], dict[Unknown, Unknown]]:
    """
