...
class Projection(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def distance(self): # -> tuple[Unknown, ...] | Projection | None:
        """
    ...
    @property
    def parallels(self): # -> tuple[Unknown, ...] | Projection | None:
        """
    ...
    @property
    def rotation(self): # -> tuple[Unknown, ...] | Projection | None:
        """
    ...
    @property
    def scale(self): # -> tuple[Unknown, ...] | Projection | None:
        """
    ...
    @property
    def tilt(self): # -> tuple[Unknown, ...] | Projection | None:
        """
