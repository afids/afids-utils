...
_log = ...
def allow_rasterization(draw): # -> _Wrapped[..., Unknown, (artist: Unknown, renderer: Unknown), Unknown]:
    """
...
class ArtistInspector:
    ...
    _NOT_LINKABLE = ...
    def aliased_name_rest(self, s, target): # -> str | LiteralString:
        """
        Return 'PROPNAME or alias' if *s* has an alias, else return 'PROPNAME',
        formatted for reST.
    ...
    def pprint_setters_rest(self, prop=..., leadingspace=...): # -> str | list[str | Any]:
        """
...
get = ...
def setp(obj, *args, file=..., **kwargs): # -> list[list[Unknown] | Unknown] | None:
    """
