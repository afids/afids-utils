...
class PolarTransform(mtransforms.Transform):
    ...
    """
    output_dims = ...
    def __init__(self, axis=..., use_rmin=..., _apply_theta_transforms=..., *, scale_transform=...) -> None:
        """
        Parameters
        ----------
...
class PolarAxes(Axes):
    ...
    def set_rlim(self, bottom=..., top=..., emit=..., auto=..., **kwargs): # -> tuple[Unknown | float, Unknown | float]:
        """
