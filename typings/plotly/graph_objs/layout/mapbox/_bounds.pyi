...
class Bounds(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def east(self): # -> tuple[Unknown, ...] | Bounds | None:
        """
    ...
    @property
    def north(self): # -> tuple[Unknown, ...] | Bounds | None:
        """
    ...
    @property
    def south(self): # -> tuple[Unknown, ...] | Bounds | None:
        """
    ...
    @property
    def west(self): # -> tuple[Unknown, ...] | Bounds | None:
        """
