...
class Mapbox(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def accesstoken(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def bearing(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def bounds(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def center(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def domain(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def layers(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def layerdefaults(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def pitch(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def style(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def uirevision(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
    ...
    @property
    def zoom(self): # -> tuple[Unknown, ...] | Mapbox | None:
        """
