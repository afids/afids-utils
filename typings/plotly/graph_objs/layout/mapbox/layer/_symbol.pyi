...
class Symbol(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def icon(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
    ...
    @property
    def iconsize(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
    ...
    @property
    def placement(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
    ...
    @property
    def text(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
    ...
    @property
    def textfont(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
    ...
    @property
    def textposition(self): # -> tuple[Unknown, ...] | Symbol | None:
        """
