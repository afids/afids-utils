...
class Label(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def font(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def padding(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def text(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def textangle(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def textposition(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def texttemplate(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def xanchor(self): # -> tuple[Unknown, ...] | Label | None:
        """
    ...
    @property
    def yanchor(self): # -> tuple[Unknown, ...] | Label | None:
        """
