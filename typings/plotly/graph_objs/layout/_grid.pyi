...
class Grid(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def columns(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def domain(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def pattern(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def roworder(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def rows(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def subplots(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def xaxes(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def xgap(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def xside(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def yaxes(self): # -> tuple[Unknown, ...] | Grid | None:
        """
        Used with `yaxes` when the x and y axes are shared across
    ...
    @property
    def ygap(self): # -> tuple[Unknown, ...] | Grid | None:
        """
    ...
    @property
    def yside(self): # -> tuple[Unknown, ...] | Grid | None:
        """
