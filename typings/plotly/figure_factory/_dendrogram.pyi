...
class _Dendrogram:
    ...
    def set_axis_layout(self, axis_key): # -> dict[Unknown, Unknown]:
        """
    ...
    def set_figure_layout(self, width, height): # -> dict[str, dict[Unknown, Unknown]]:
        """
    ...
    def get_dendrogram_traces(self, X, colorscale, distfun, linkagefun, hovertext, color_threshold): # -> tuple[list[Unknown], Any, Any, Any, Any]:
        """
