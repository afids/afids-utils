...
def to_unindexed_series(x, name=...): # -> Series:
    """
...
def process_dataframe_pie(args, trace_patch): # -> tuple[Unknown, Unknown]:
    ...

def infer_config(args, constructor, trace_patch, layout_patch):
    ...

def get_groups_and_orders(args, grouper): # -> tuple[dict[tuple[Unknown, ...], Unknown], Unknown | dict[Unknown, Unknown]]:
    """
