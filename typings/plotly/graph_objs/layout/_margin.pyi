...
class Margin(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def autoexpand(self): # -> tuple[Unknown, ...] | Margin | None:
        """
    ...
    @property
    def b(self): # -> tuple[Unknown, ...] | Margin | None:
        """
    ...
    @property
    def l(self): # -> tuple[Unknown, ...] | Margin | None:
        """
    ...
    @property
    def pad(self): # -> tuple[Unknown, ...] | Margin | None:
        """
    ...
    @property
    def r(self): # -> tuple[Unknown, ...] | Margin | None:
        """
    ...
    @property
    def t(self): # -> tuple[Unknown, ...] | Margin | None:
        """
