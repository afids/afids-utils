...
class Title(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def automargin(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def pad(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def x(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def xanchor(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def xref(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def y(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def yanchor(self): # -> tuple[Unknown, ...] | Title | None:
        """
    ...
    @property
    def yref(self): # -> tuple[Unknown, ...] | Title | None:
        """
