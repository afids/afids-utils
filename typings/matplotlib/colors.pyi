...
def make_norm_from_scale(scale_cls, base_norm_cls=..., *, init=...): # -> partial[Unknown] | type[Norm]:
    """
...
LogNorm = ...
@make_norm_from_scale(scale.SymmetricalLogScale, init=lambda linthresh, linscale = 1, vmin = None, vmax = None, clip = False, *, base = 10: None)
...
class LightSource:
    ...
    """
    def __init__(self, azdeg=..., altdeg=..., hsv_min_val=..., hsv_max_val=..., hsv_min_sat=..., hsv_max_sat=...) -> None:
        """
    ...
    def shade(self, data, cmap, norm=..., blend_mode=..., vmin=..., vmax=..., vert_exag=..., dx=..., dy=..., fraction=..., **kwargs):
        """
    ...
    def shade_rgb(self, rgb, elevation, fraction=..., blend_mode=..., vert_exag=..., dx=..., dy=..., **kwargs): # -> ndarray[Any, dtype[Any]]:
        """
    ...
    def blend_hsv(self, rgb, intensity, hsv_max_sat=..., hsv_max_val=..., hsv_min_val=..., hsv_min_sat=...): # -> ndarray[Any, dtype[Any]]:
        """
...
def from_levels_and_colors(levels, colors, extend=...): # -> tuple[ListedColormap, BoundaryNorm]:
    """
