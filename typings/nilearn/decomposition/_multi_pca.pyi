...
class _MultiPCA(_BaseDecomposition):
    ...
    """
    def __init__(self, n_components=..., mask=..., smoothing_fwhm=..., do_cca=..., random_state=..., standardize=..., standardize_confounds=..., detrend=..., low_pass=..., high_pass=..., t_r=..., target_affine=..., target_shape=..., mask_strategy=..., mask_args=..., memory=..., memory_level=..., n_jobs=..., verbose=...) -> None:
        ...
