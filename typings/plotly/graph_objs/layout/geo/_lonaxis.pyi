...
class Lonaxis(_BaseLayoutHierarchyType):
    ...
    _valid_props = ...
    @property
    def dtick(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def gridcolor(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def griddash(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def gridwidth(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def range(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def showgrid(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
    ...
    @property
    def tick0(self): # -> tuple[Unknown, ...] | Lonaxis | None:
        """
