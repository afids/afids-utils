...
@fill_doc
def make_glm_report(model, contrasts, title=..., bg_img=..., threshold=..., alpha=..., cluster_threshold=..., height_control=..., two_sided=..., min_distance=..., plot_type=..., cut_coords=..., display_mode=..., report_dims=...): # -> HTMLReport:
