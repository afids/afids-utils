...
class Transform(TransformNode):
    ...
    def __add__(self, other): # -> Transform | Self@Transform | CompositeAffine2D | CompositeGenericTransform | _NotImplementedType:
        """
...
class Affine2DBase(AffineBase):
    ...
    def to_values(self): # -> tuple[float64 | _ScalarType@__next__, ...]:
        """
...
def blended_transform_factory(x_transform, y_transform): # -> BlendedAffine2D | BlendedGenericTransform:
    """
...
def composite_transform_factory(a, b): # -> CompositeAffine2D | CompositeGenericTransform:
    """
...
def nonsingular(vmin, vmax, expander=..., tiny=..., increasing=...): # -> tuple[float, float]:
    """
