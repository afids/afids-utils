...
class BaseGLM(BaseEstimator, TransformerMixin, CacheMixin):
    ...
    def generate_report(self, contrasts, title=..., bg_img=..., threshold=..., alpha=..., cluster_threshold=..., height_control=..., min_distance=..., plot_type=..., display_mode=..., report_dims=...): # -> HTMLReport:
